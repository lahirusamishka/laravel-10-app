...
<style lang="scss" src="./css/multiselect.scss">

</style>

<div class="form-select" class:readonly>
  ...
  <select bind:this={slot} type="multiple" class="hidden" multiple>
    <slot />
  </select>

  {#if showOptions}
    <ul
      class="options rounded shadow"
      transition:fly={{ duration: 400, y: 5 }}
